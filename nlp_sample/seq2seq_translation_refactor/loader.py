...
def get_dataloader(data: List[Tuple[torch.Tensor]], ja_vocab: Vocab, en_vocab: Vocab) -> DataLoader:
    global PAD_INDEX
    global BOS_INDEX
    global EOS_INDEX
    PAD_INDEX = ja_vocab["<pad>"]
    BOS_INDEX = ja_vocab["<bos>"]
    EOS_INDEX = ja_vocab["<eos>"]
